...
public class NextDaysSecondWeatherFragment extends Fragment {
    ...
    public NextDaysSecondWeatherFragment(Context context, WeatherInfo info, WeatherResProvider res) {
    ...
    public void updateWeather(WeatherInfo info, WeatherResProvider res, Context context) {
        ...
        DayForecast day1 = res.getPreFixedWeatherInfo(context, getDayForecast(days, 3));
        DayForecast day2 = res.getPreFixedWeatherInfo(context, getDayForecast(days, 4));
        DayForecast day3 = res.getPreFixedWeatherInfo(context, getDayForecast(days, 5));
        
        if (day1 != null) {
            weekTv1.setText(res.getWeek(day1, context));
